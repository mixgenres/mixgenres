...
export const LUTHIER_INSTRUMENT_MAP: Record<string, LuthierPhysicalParameters> = {
  ...
  washboard: { category: 'membrane_tension_2d', materialDensity: 0.8, tension: 0.8, bodyResonanceVolume: 2.0, decayTimeFactor: 0.4, harmonicRichness: 0.8 },
  tantan: { category: 'membrane_tension_2d', materialDensity: 0.8, tension: 0.8, bodyResonanceVolume: 20.0, decayTimeFactor: 0.8, harmonicRichness: 0.6 },
  repinique: { category: 'membrane_tension_2d', materialDensity: 0.85, tension: 0.95, bodyResonanceVolume: 6.0, decayTimeFactor: 0.5, harmonicRichness: 0.85 },
  cuica: { category: 'membrane_tension_2d', materialDensity: 0.8, tension: 0.8, bodyResonanceVolume: 5.0, decayTimeFactor: 0.7, harmonicRichness: 0.8 },
  dikanza: { category: 'membrane_tension_2d', materialDensity: 0.8, tension: 0.8, bodyResonanceVolume: 3.0, decayTimeFactor: 0.4, harmonicRichness: 0.8 },
  ...
  'acoustic-guitar': { category: 'strum_friction_pluck', materialDensity: 0.7, tension: 0.75, bodyResonanceVolume: 14.0, decayTimeFactor: 2.8, harmonicRichness: 0.7, courses: 1, bodyConstruction: 'wood-box', excitationType: 'fingerpad' },
  'steel-guitar': { category: 'strum_friction_pluck', materialDensity: 0.85, tension: 0.8, bodyResonanceVolume: 15.0, decayTimeFactor: 3.5, harmonicRichness: 0.8, courses: 1, bodyConstruction: 'wood-box', excitationType: 'hard-pick' },
  '12-string-guitar': { category: 'strum_friction_pluck', materialDensity: 0.88, tension: 0.82, bodyResonanceVolume: 17.0, decayTimeFactor: 3.6, harmonicRichness: 0.85, courses: 2, bodyConstruction: 'wood-box', excitationType: 'hard-pick' },
  'electric-guitar': { category: 'strum_friction_pluck', materialDensity: 0.9, tension: 0.8, bodyResonanceVolume: 5.0, decayTimeFactor: 4.0, harmonicRichness: 0.85, courses: 1, bodyConstruction: 'solid-electric', excitationType: 'hard-pick' },
  'jazz-guitar': { category: 'strum_friction_pluck', materialDensity: 0.8, tension: 0.72, bodyResonanceVolume: 16.0, decayTimeFactor: 3.2, harmonicRichness: 0.6, courses: 1, bodyConstruction: 'wood-box', excitationType: 'fingerpad' },
  'distortion-guitar': { category: 'strum_friction_pluck', materialDensity: 0.95, tension: 0.85, bodyResonanceVolume: 5.0, decayTimeFactor: 5.0, harmonicRichness: 0.98, courses: 1, bodyConstruction: 'solid-electric', excitationType: 'hard-pick' },
  'overdrive-guitar': { category: 'strum_friction_pluck', materialDensity: 0.92, tension: 0.82, bodyResonanceVolume: 5.0, decayTimeFactor: 4.4, harmonicRichness: 0.92, courses: 1, bodyConstruction: 'solid-electric', excitationType: 'hard-pick' },
  'muted-guitar': { category: 'strum_friction_pluck', materialDensity: 0.75, tension: 0.7, bodyResonanceVolume: 4.0, decayTimeFactor: 0.5, harmonicRichness: 0.55, courses: 1, bodyConstruction: 'solid-electric', excitationType: 'hard-pick' },
  'guitar-harmonics': { category: 'strum_friction_pluck', materialDensity: 0.6, tension: 0.85, bodyResonanceVolume: 3.0, decayTimeFactor: 2.2, harmonicRichness: 0.9, courses: 1, bodyConstruction: 'wood-box', excitationType: 'nail' },
  requinto: { category: 'strum_friction_pluck', materialDensity: 0.65, tension: 0.8, bodyResonanceVolume: 7.0, decayTimeFactor: 2.0, harmonicRichness: 0.75, courses: 1, bodyConstruction: 'wood-box', excitationType: 'plectrum' },
  jarana: { category: 'strum_friction_pluck', materialDensity: 0.65, tension: 0.82, bodyResonanceVolume: 5.0, decayTimeFactor: 1.6, harmonicRichness: 0.75, courses: 2, bodyConstruction: 'wood-box', excitationType: 'nail' },
  guqin: { category: 'strum_friction_pluck', materialDensity: 0.45, tension: 0.55, bodyResonanceVolume: 8.0, decayTimeFactor: 3.5, harmonicRichness: 0.4, courses: 1, bodyConstruction: 'board', excitationType: 'fingerpad' },
  pipa: { category: 'strum_friction_pluck', materialDensity: 0.7, tension: 0.85, bodyResonanceVolume: 6.0, decayTimeFactor: 1.5, harmonicRichness: 0.8, courses: 1, bodyConstruction: 'wood-box', excitationType: 'nail' },
  guzheng: { category: 'strum_friction_pluck', materialDensity: 0.55, tension: 0.72, bodyResonanceVolume: 28.0, decayTimeFactor: 2.8, harmonicRichness: 0.7, courses: 1, bodyConstruction: 'board', excitationType: 'nail' },
  tres: {
    category: 'strum_friction_pluck',
  ...
  cuatro: { category: 'strum_friction_pluck', materialDensity: 0.65, tension: 0.75, bodyResonanceVolume: 6.0, decayTimeFactor: 1.8, harmonicRichness: 0.75, courses: 1, bodyConstruction: 'wood-box', excitationType: 'nail' },
  cavaquinho: { category: 'strum_friction_pluck', materialDensity: 0.7, tension: 0.9, bodyResonanceVolume: 3.0, decayTimeFactor: 1.5, harmonicRichness: 0.8, courses: 1, bodyConstruction: 'wood-box', excitationType: 'plectrum' },
  charango: { category: 'strum_friction_pluck', materialDensity: 0.65, tension: 0.88, bodyResonanceVolume: 2.5, decayTimeFactor: 1.4, harmonicRichness: 0.8, courses: 2, bodyConstruction: 'wood-box', excitationType: 'nail' },
  oud: { category: 'strum_friction_pluck', materialDensity: 0.68, tension: 0.78, bodyResonanceVolume: 18.0, decayTimeFactor: 2.2, harmonicRichness: 0.85, courses: 2, bodyConstruction: 'wood-box', excitationType: 'plectrum' },
  bouzouki: { category: 'strum_friction_pluck', materialDensity: 0.78, tension: 0.88, bodyResonanceVolume: 10.0, decayTimeFactor: 2.4, harmonicRichness: 0.85, courses: 2, bodyConstruction: 'wood-box', excitationType: 'plectrum' },
  guitarron: { category: 'strum_friction_pluck', materialDensity: 0.55, tension: 0.5, bodyResonanceVolume: 45.0, decayTimeFactor: 2.8, harmonicRichness: 0.5, courses: 1, bodyConstruction: 'wood-box', excitationType: 'fingerpad' },
  mandolin: { category: 'strum_friction_pluck', materialDensity: 0.75, tension: 0.92, bodyResonanceVolume: 4.0, decayTimeFactor: 1.8, harmonicRichness: 0.85, courses: 2, bodyConstruction: 'wood-box', excitationType: 'plectrum' },
  banjo: { category: 'strum_friction_pluck', materialDensity: 0.85, tension: 0.85, bodyResonanceVolume: 6.0, decayTimeFactor: 1.6, harmonicRichness: 0.9, courses: 1, bodyConstruction: 'skin-faced', excitationType: 'hard-pick' },
  vihuela: { category: 'strum_friction_pluck', materialDensity: 0.55, tension: 0.7, bodyResonanceVolume: 7.0, decayTimeFactor: 1.8, harmonicRichness: 0.7, courses: 1, bodyConstruction: 'wood-box', excitationType: 'fingerpad' },
  sitar: { category: 'strum_friction_pluck', materialDensity: 0.6, tension: 0.75, bodyResonanceVolume: 22.0, decayTimeFactor: 4.5, harmonicRichness: 0.95, courses: 1, bodyConstruction: 'gourd', excitationType: 'plectrum', sympatheticStrings: true },
  shamisen: { category: 'strum_friction_pluck', materialDensity: 0.8, tension: 0.8, bodyResonanceVolume: 5.0, decayTimeFactor: 1.2, harmonicRichness: 0.85, courses: 1, bodyConstruction: 'skin-faced', excitationType: 'plectrum' },
  kora: { category: 'strum_friction_pluck', materialDensity: 0.6, tension: 0.72, bodyResonanceVolume: 24.0, decayTimeFactor: 3.2, harmonicRichness: 0.75, courses: 1, bodyConstruction: 'gourd', excitationType: 'fingerpad' },
  berimbau: { category: 'strum_friction_pluck', materialDensity: 0.7, tension: 0.8, bodyResonanceVolume: 8.0, decayTimeFactor: 1.8, harmonicRichness: 0.8, courses: 1, bodyConstruction: 'gourd', excitationType: 'hard-pick' },
  koto: { category: 'strum_friction_pluck', materialDensity: 0.55, tension: 0.7, bodyResonanceVolume: 30.0, decayTimeFactor: 3.0, harmonicRichness: 0.7, courses: 1, bodyConstruction: 'board', excitationType: 'fingerpad' },
  kalimba: { category: 'strum_friction_pluck', materialDensity: 0.9, tension: 0.8, bodyResonanceVolume: 2.0, decayTimeFactor: 2.0, harmonicRichness: 0.4, courses: 1, bodyConstruction: 'wood-box', excitationType: 'fingerpad' },
  bass: {
    category: 'strum_friction_pluck',
  ...
  dulcimer: { category: 'resonator_struck_metal_wood', materialDensity: 0.7, tension: 0.8, bodyResonanceVolume: 5.0, decayTimeFactor: 2.5, harmonicRichness: 0.7, courses: 2, bodyConstruction: 'board', excitationType: 'hammer' },
  ...
  steel_drums: { category: 'resonator_struck_metal_wood', materialDensity: 0.85, tension: 0.7, bodyResonanceVolume: 15.0, decayTimeFactor: 2.0, harmonicRichness: 0.7 },
  'foot-stomp': { category: 'membrane_tension_2d', materialDensity: 0.85, tension: 0.5, bodyResonanceVolume: 30.0, decayTimeFactor: 0.5, harmonicRichness: 0.4 },
  foot_stomp: { category: 'membrane_tension_2d', materialDensity: 0.85, tension: 0.5, bodyResonanceVolume: 30.0, decayTimeFactor: 0.5, harmonicRichness: 0.4 },
  'hand-percussion': { category: 'membrane_tension_2d', materialDensity: 0.75, tension: 0.8, bodyResonanceVolume: 4.0, decayTimeFactor: 0.4, harmonicRichness: 0.75 },
  hand_percussion: { category: 'membrane_tension_2d', materialDensity: 0.75, tension: 0.8, bodyResonanceVolume: 4.0, decayTimeFactor: 0.4, harmonicRichness: 0.75 },
  harmonium: { category: 'bellows_free_reed', materialDensity: 0.75, tension: 0.7, bodyResonanceVolume: 20.0, decayTimeFactor: 1.4, harmonicRichness: 0.85, airResonanceHz: 260 },
  'slide-guitar': { category: 'strum_friction_pluck', materialDensity: 0.6, tension: 0.75, bodyResonanceVolume: 14.0, decayTimeFactor: 2.8, harmonicRichness: 0.85, courses: 1, bodyConstruction: 'wood-box', excitationType: 'hard-pick' },
  slide_guitar: { category: 'strum_friction_pluck', materialDensity: 0.6, tension: 0.75, bodyResonanceVolume: 14.0, decayTimeFactor: 2.8, harmonicRichness: 0.85, courses: 1, bodyConstruction: 'wood-box', excitationType: 'hard-pick' },
  drone: { category: 'electro_acoustic_algorithmic', materialDensity: 0.5, tension: 0.5, bodyResonanceVolume: 35.0, decayTimeFactor: 8.0, harmonicRichness: 0.8 },
  sampler: { category: 'electro_acoustic_algorithmic', materialDensity: 0.5, tension: 0.5, bodyResonanceVolume: 12.0, decayTimeFactor: 1.5, harmonicRichness: 0.75 },
  'spring-reverb': { category: 'electro_acoustic_algorithmic', materialDensity: 0.65, tension: 0.6, bodyResonanceVolume: 8.0, decayTimeFactor: 3.0, harmonicRichness: 0.65 },
  spring_reverb: { category: 'electro_acoustic_algorithmic', materialDensity: 0.65, tension: 0.6, bodyResonanceVolume: 8.0, decayTimeFactor: 3.0, harmonicRichness: 0.65 },
  'tape-echo': { category: 'electro_acoustic_algorithmic', materialDensity: 0.45, tension: 0.5, bodyResonanceVolume: 6.0, decayTimeFactor: 2.5, harmonicRichness: 0.8 },
  tape_echo: { category: 'electro_acoustic_algorithmic', materialDensity: 0.45, tension: 0.5, bodyResonanceVolume: 6.0, decayTimeFactor: 2.5, harmonicRichness: 0.8 },
  ...
  organ: { category: 'electro_acoustic_algorithmic', materialDensity: 0.55, tension: 0.35, bodyResonanceVolume: 80.0, decayTimeFactor: 6.0, harmonicRichness: 0.72, articulationCapabilities: ['legato', 'staccato', 'accent', 'swell'], genreAdaptable: true },
  'rock-organ': { category: 'electro_acoustic_algorithmic', materialDensity: 0.55, tension: 0.4, bodyResonanceVolume: 70.0, decayTimeFactor: 5.0, harmonicRichness: 0.82, articulationCapabilities: ['staccato', 'accent', 'swell'], genreAdaptable: true },
  crystal: { category: 'resonator_struck_metal_wood', materialDensity: 0.98, tension: 0.92, bodyResonanceVolume: 2.0, decayTimeFactor: 4.5, harmonicRichness: 0.92 },
  'synth-brass': { category: 'electro_acoustic_algorithmic', materialDensity: 0.45, tension: 0.7, bodyResonanceVolume: 9.0, decayTimeFactor: 1.8, harmonicRichness: 0.88, articulationCapabilities: ['staccato', 'accent', 'swell'], genreAdaptable: true },
  'noise-sweep': { category: 'electro_acoustic_algorithmic', materialDensity: 0.2, tension: 0.2, bodyResonanceVolume: 20.0, decayTimeFactor: 4.0, harmonicRichness: 0.95 },
  'dub-echo': { category: 'electro_acoustic_algorithmic', materialDensity: 0.2, tension: 0.2, bodyResonanceVolume: 35.0, decayTimeFactor: 6.0, harmonicRichness: 0.8 },
  turntable: { category: 'electro_acoustic_algorithmic', materialDensity: 0.25, tension: 0.25, bodyResonanceVolume: 3.0, decayTimeFactor: 1.2, harmonicRichness: 0.95, articulationCapabilities: ['staccato', 'accent', 'scratch'] },
  'saw-lead': { category: 'electro_acoustic_algorithmic', materialDensity: 0.3, tension: 0.5, bodyResonanceVolume: 8.0, decayTimeFactor: 2.5, harmonicRichness: 0.98, articulationCapabilities: ['staccato', 'legato', 'portamento', 'vibrato'] },
  'square-lead': { category: 'electro_acoustic_algorithmic', materialDensity: 0.3, tension: 0.5, bodyResonanceVolume: 7.0, decayTimeFactor: 2.2, harmonicRichness: 0.9, articulationCapabilities: ['staccato', 'legato', 'portamento', 'vibrato'] },
  'warm-pad': { category: 'electro_acoustic_algorithmic', materialDensity: 0.25, tension: 0.35, bodyResonanceVolume: 30.0, decayTimeFactor: 8.0, harmonicRichness: 0.55, articulationCapabilities: ['legato', 'crescendo', 'diminuendo'] },
  'synth-strings': { category: 'electro_acoustic_algorithmic', materialDensity: 0.3, tension: 0.45, bodyResonanceVolume: 25.0, decayTimeFactor: 7.0, harmonicRichness: 0.62, articulationCapabilities: ['legato', 'tremolo', 'crescendo'] },
  'bass-lead': { category: 'electro_acoustic_algorithmic', materialDensity: 0.35, tension: 0.45, bodyResonanceVolume: 18.0, decayTimeFactor: 2.8, harmonicRichness: 0.9, articulationCapabilities: ['staccato', 'legato', 'portamento', 'bend'] },
  polysynth: { category: 'electro_acoustic_algorithmic', materialDensity: 0.3, tension: 0.4, bodyResonanceVolume: 25.0, decayTimeFactor: 4.0, harmonicRichness: 0.88, articulationCapabilities: ['staccato', 'legato', 'portamento'] },
  'halo-pad': { category: 'electro_acoustic_algorithmic', materialDensity: 0.2, tension: 0.3, bodyResonanceVolume: 45.0, decayTimeFactor: 10.0, harmonicRichness: 0.72, articulationCapabilities: ['legato', 'crescendo', 'diminuendo'] },
  'sweep-pad': { category: 'electro_acoustic_algorithmic', materialDensity: 0.2, tension: 0.3, bodyResonanceVolume: 50.0, decayTimeFactor: 9.0, harmonicRichness: 0.78, articulationCapabilities: ['legato', 'crescendo', 'diminuendo'] },
};
