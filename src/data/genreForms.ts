...
export const GENRE_FORMS: Record<string, GenreForm> = {
  ...
  // 4. FLAMENCO (BPM: 108, 72 bars = 160s)
  flamenco: {
    steps: [
      F('falseta-1', 'intro', 12, 'Falseta 1', 'low'),
      F('letra-1', 'verse', 12, 'Letra 1', 'medium'),
      F('falseta-2', 'solo', 12, 'Falseta 2', 'medium'),
      F('letra-2', 'verse', 12, 'Letra 2', 'high'),
      F('remate', 'mambo', 12, 'Remate', 'peak'),
      F('cierre', 'ending', 12, 'Cierre', 'low'),
    ],
    allowed: ['falseta-1', 'letra-1', 'falseta-2', 'letra-2', 'remate', 'cierre'],
    densities: {
      'falseta-1': { guitar: 'normal', requinto: 'sparse', 'upright-bass': 'sparse', cajon: 'sparse', flute: 'sparse' },
      'letra-1': { guitar: 'normal', requinto: 'normal', 'upright-bass': 'normal', cajon: 'normal', flute: 'sparse' },
      'falseta-2': { guitar: 'busy', requinto: 'normal', 'upright-bass': 'normal', cajon: 'normal', flute: 'normal' },
      'letra-2': { guitar: 'normal', requinto: 'normal', 'upright-bass': 'normal', cajon: 'busy', flute: 'normal' },
      remate: { guitar: 'busy', requinto: 'busy', 'upright-bass': 'normal', cajon: 'busy', flute: 'busy' },
      cierre: { guitar: 'sparse', requinto: 'sparse', 'upright-bass': 'sparse', cajon: 'sparse', flute: 'sparse' },
    },
  },
...
export const DEFAULT_PATTERN_PREFERENCES: Record<string, Record<string, string>> = {
  ...
  flamenco: {
    guitar: 'flamenco-golpe',
    requinto: 'flamenco-picado',
    'upright-bass': 'flam-alzapua-bass',
    cajon: 'flamenco-bulerias-palmas',
    flute: 'flam-falseta-melodic',
  },
  jazz: {
...
export const PROGRESSIONS: Record<string, string[]> = {
  tango: ['Am', 'Am', 'Dm', 'E7'],
  salsa: ['Dm7', 'G7', 'Cmaj7', 'A7'],
  timba: ['Cm7', 'Fm7', 'G7', 'Cm7'],
  flamenco: ['Am', 'G', 'F', 'E7'],
  bachata: ['Bm', 'G', 'D', 'A'],
  zouk: ['Fmaj7', 'Dm7', 'Gm7', 'C7'],
  kizomba: ['Dm', 'Bb', 'F', 'C'],
  jazz: ['Dm7', 'G7', 'Cmaj7', 'Cmaj7'],
  blues: ['A7', 'A7', 'A7', 'A7', 'D7', 'D7', 'A7', 'A7', 'E7', 'D7', 'A7', 'E7'],
  rock: ['Em', 'C', 'G', 'D'],
  'rock-en-espanol': ['Am', 'F', 'C', 'G'],
  funk: ['Em9', 'A7', 'Em9', 'A7'],
  metal: ['Em', 'Em', 'C', 'B7'],
  folk: ['C', 'G', 'Am', 'F'],
  'hip-hop': ['Cm', 'Cm', 'Fm', 'Gm'],
  electronic: ['Am', 'F', 'C', 'G'],
  country: ['G', 'C', 'G', 'D7'],
  swing: ['Cmaj7', 'Am7', 'Dm7', 'G7'],
  'math-rock': ['Em9', 'Cmaj7', 'Gmaj7', 'Aadd9'],
  afrobeats: ['Am7', 'Fmaj7', 'Cmaj7', 'G6'],
  'j-pop': ['Fmaj7', 'G7', 'Em7', 'Am7'],
  'chinese-rock': ['Am', 'F', 'C', 'G'],
  'fusion-ambient': ['Dm9', 'Bbmaj7', 'Fmaj7', 'Cadd9'],
  'chinese-traditional': ['Am', 'Am', 'Dm', 'Am'],
  'japanese-traditional': ['Dm', 'Gm', 'Dm', 'A7'],
  'reggaeton-dembow': ['Am', 'F', 'C', 'G'],
  cumbia: ['Am', 'G', 'F', 'E7'],
  trova: ['C', 'Am', 'Dm7', 'G7'],
  folclorico: ['Am', 'G', 'F', 'E7'],
  'house-techno': ['Am7', 'Am7', 'Fmaj7', 'G6'],
  'reggae-dub': ['Am', 'Am', 'Dm', 'Am'],
  ska: ['C', 'Am', 'F', 'G'],
  'samba-bossa': ['Dm7', 'G7', 'Cmaj7', 'A7'],
  'celtic-trad': ['D', 'G', 'A', 'D', 'Bm', 'G', 'A', 'D'],
};
