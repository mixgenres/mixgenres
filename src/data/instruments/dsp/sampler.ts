...
/** Deep physical profile override for Sampler. Generated from this instrument's luthierPhysics, techniques, playingStyles and acoustic role; not a generic family alias. */
export const dspOverride: InstrumentDSPOverride = {
  "instrumentCharacter": {
    ...
    "couplingPaths": [],
    "techniqueBindings": [
      "sample-selection attack",
      "one-shot transient shaping",
      "looped sustain and release"
    ]
  },
  "excitationDynamics": {
    "hardness": 0.25,
    "pressureSensitivity": 0.495,
    "nonlinearDrive": 0.085,
