...
export const spanish_guitar: InstrumentDef = {
  ...
  techniques: {
    articulations: ["accent", "staccato", "legato", "rasgueado", "alzapua", "tremolo", "arrastre", "palm-mute", "golpe"],
    techniqueMethods: ["picado", "ligado", "pulgar-apoyando", "rasgueado", "alzapúa", "golpe", "tirando"],
