...
export const violin: InstrumentDef = {
  ...
  tuningAndMechanics: {
    ...
    openStrings: [
      ...
      { name: 'A4', note: 'A4', midi: 69, frequencyHz: 440.00 },
      { name: 'E5', note: 'E5', midi: 76, frequencyHz: 659.25 }
    ]
  },
  ...
  techniques: {
    articulations: ["accent", "staccato", "legato", "portato", "tremolo", "pizzicato", "vibrato", "spiccato"],
