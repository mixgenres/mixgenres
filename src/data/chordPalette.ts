...
const SHARED_CHORDS: ChordOption[] = [
  { id:'diatonic-I-V-vi-IV', tier:'shared', name:'I–V–vi–IV', chords:['C','G','Am','F'], mood:'warm-resolved', blurb:'The universal four-chord pop cycle', genres:['country','folk','rock','disco','gospel','house','ska'], aliases:['pop four-chord cycle'] },
  ...
  { id:'doo-wop-I-vi-IV-V', tier:'shared', name:'I–vi–IV–V', chords:['C','Am','F','G'], mood:'warm-resolved', blurb:'The classic 1950s doo-wop cycle', genres:['disco','soul','ska'], aliases:['50s progression'] },
  ...
  { id:'canon-descent', tier:'shared', name:'I–V–vi–iii', chords:['C','G','Am','Em'], mood:'bittersweet', blurb:'Descending stepwise diatonic motion', genres:['folk','brazilian'], aliases:['Pachelbel-style descent'] },
...
export interface ChordVoicingDefinition {
  name: string;
  intervals: number[];
  preferredInversion?: number;
  voiceLeadingPriority?: 'low' | 'medium' | 'high' | string;
}

export const extendedChordPalette: Record<string, ChordVoicingDefinition> = {
  // Altered Dominant
  'alt7_b9_b13': {
    name: '7 Altered (b9, b13)',
    intervals: [0, 4, 10, 13, 20], // 1, 3, b7, b9, b13
    preferredInversion: 0,
    voiceLeadingPriority: 'high',
  },
  
  // Half-Diminished 11
  'min11_b5': {
    name: 'Minor 11 (b5) / Half-Diminished 11',
    intervals: [0, 3, 6, 10, 17], // 1, b3, b5, b7, 11
    preferredInversion: 1,
    voiceLeadingPriority: 'medium',
  },

  // Dominant 7 Suspended (add9)
  '7sus4_add9': {
    name: '7sus4 (add9)',
    intervals: [0, 5, 7, 10, 14], // 1, 4, 5, b7, 9
    preferredInversion: 0,
    voiceLeadingPriority: 'medium',
  },

  // Major 7 Sharp 11 (Lydian)
  'maj7_sharp11': {
    name: 'Major 7 (#11)',
    intervals: [0, 4, 7, 11, 18], // 1, 3, 5, 7, #11
    preferredInversion: 2,
    voiceLeadingPriority: 'high',
  },
};

export const chordPalette: Record<string, ChordVoicingDefinition> = {
  'maj79_sharp11': {
    name: 'Major 9 (#11)',
    intervals: [0, 4, 7, 11, 14, 18], // 1, 3, 5, 7, 9, #11
    preferredInversion: 1,
  },
  'phrygian_dominant_add9_b13': {
    name: 'Phrygian Dominant (add9, b13)',
    intervals: [0, 1, 4, 7, 8, 14], // 1, b2, 3, 5, b6, 9
    preferredInversion: 0,
  },
  ...extendedChordPalette,
};
