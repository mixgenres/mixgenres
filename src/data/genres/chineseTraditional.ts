...
export const CHINESE_TRADITIONAL_WORLD: GenreWorld = {
  ...
  "traditions": [
    {
      "id": "chinese-traditional-jiangnan-sizhu",
      "worldId": "chinese-traditional",
      "name": "Jiangnan Sizhu",
      "origin": "Jiangnan Region (Shanghai, Jiangsu, Zhejiang)",
      "era": "Ming/Qing Dynasties–Present",
      "description": "Silk & Bamboo • Flowing • Heterophonic\nTeahouse chamber ensemble.\nShanghai Sizhu Ensemble · Min Huifen",
      ...
      "keySubstyles": [
        "Teahouse Silk and Bamboo",
        "Traditional Eight Great Pieces"
      ],
      "coreConcepts": [
        "heterophonic simultaneous variations (jia-hua adding flowers)",
        "pentatonic modal purity",
        "bamboo and silk natural timbre",
        "relaxed unhurried teahouse aesthetic"
      ],
      "rhythmicGrammar": [
        "ban-yan meter starting slow and unhurried then accelerating smoothly"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "Heterophonic ornamentation where dizi and erhu weave simultaneous flowers around pipa skeleton",
      "grooveMechanics": {
        "swingPercentage": 50,
    ...
    },
    {
      ...
      "worldId": "chinese-traditional",
      "name": "Guqin Music",
      "origin": "Ancient China (Literati Tradition)",
      "era": "Ancient (Over 3000 years)",
      "description": "Meditative • Literati • Microtonal\nAncient 7-string zither.\nGuan Pinghu · Wu Wenguang",
      "characteristicInstruments": [
        "guqin",
        "xiao"
      ],
      ...
      "keySubstyles": [
        "Jiu Kuang (Wine Madness)",
        "Ping Sha Luo Yan (Wild Geese)"
      ],
      "coreConcepts": [
        "yin-yang philosophical silence and resonance",
        "harmonics (fan-yin) like floating stars",
        "microtonal sliding (yin, rou, chuo, zhu)",
        "contemplative scholar solitude"
      ],
      "rhythmicGrammar": [
        "free unmeasured breath phrasing with precise finger-touch nuances"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "Crystalline guqin harmonic followed by deep sliding microtonal portamento and breath silence",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
    ...
    {
      "id": "chinese-traditional-beiqu",
      "worldId": "chinese-traditional",
      "name": "Beiqu",
      "origin": "Northern China",
      "era": "Yuan Dynasty",
      "description": "Vigorous • Dramatic • High-pitched\nNorthern opera and theater singing.\nNorthern Kunqu Theatre · Hou Shaokui",
      "characteristicInstruments": [
        "jinghu",
        "suona",
        "percussion",
      ...
      "keySubstyles": [
        "Yuan Zaju",
        "Northern Opera Vocal"
      ],
      "coreConcepts": [
        "bold vigorous vocal projections",
        "piercing suona lead flourishes",
        "dramatic percussion punctuations (luo and gu)",
        "heroic narrative arcs"
      ],
      "rhythmicGrammar": [
        "strong ban downbeats accented with sharp woodblock (bangu) and gongs"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "12-tet",
      "signatureCell": "Piercing suona fanfare followed by sharp bangu woodblock crack and dramatic vocal entry",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "straight"
    ...
    {
      "id": "chinese-traditional-peking-opera",
      "worldId": "chinese-traditional",
      "name": "Peking Opera",
      "origin": "Beijing, China",
      "era": "Late 18th Century–Present",
      "description": "Theatrical • Stylized • Percussive\nIconic opera vocal and acrobatic art.\nMei Lanfang · Cheng Yanqiu",
      "characteristicInstruments": [
        "jinghu",
        "erhu",
        "percussion",
      ...
      "coreConcepts": [
        "jinghu bowed lead with intense tight snakeskin buzz",
        "stylized falsetto vocal ornamentation",
        "percussive gongs and clappers regulating stage action",
        "rigid modal formulas"
      ],
      "rhythmicGrammar": [
        "bangu clapper leading gongs to signal pauses, turns, and emotional climaxes"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "High-pitched jinghu bowed glide matching dramatic opera vocal melisma over bangu gongs",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "straight"
    ...
    {
      "id": "chinese-traditional-guzheng",
      "worldId": "chinese-traditional",
      "name": "Guzheng Solo",
      "origin": "Ancient/Modern China",
      "era": "Qin Dynasty–Present",
      "description": "Resonant • Cascading • Expressive\nVirtuosic 21-string plucked zither.\nWang Zhongshan · Yuan Sha",
      "characteristicInstruments": [
        "guzheng",
        "xiao",
        "hand-percussion"
      ...
      "coreConcepts": [
        "cascading sweeping right-hand glissandi (hua-zhi)",
        "left-hand pitch bends and vibrato (an, rou, hua, chan)",
        "rich resonant hollow body resonance",
        "dramatic tempo acceleration"
      ],
      "rhythmicGrammar": [
        "flowing pentatonic arpeggios that evolve from peaceful lakes to rushing river torrents"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "Dramatic sweeping right-hand glissando with deep left-hand string bend vibrato",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "rubato"
    ...
    {
      "id": "chinese-traditional-erhu",
      "worldId": "chinese-traditional",
      "name": "Erhu Soliloquy",
      "origin": "China",
      "era": "Tang Dynasty–Present",
      "description": "Poignant • Singing • Bowed\nExpressive two-string fiddle soliloquy.\nLiu Tianhua · Song Fei",
      "characteristicInstruments": [
        "erhu",
        "yangqin",
        "guzheng"
      ...
      "keySubstyles": [
        ...
        "Birds Singing in the Desolate Mountain"
      ],
      "coreConcepts": [
        "singing human-like vocal timbre",
        "expressive portamento slides and finger vibrato",
        "horsehair bow pinned between two strings",
        "deeply introspective emotional pathos"
      ],
      "rhythmicGrammar": [
        "expressive rubato phrasing with delicate breathing pauses at phrase ends"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "Heart-wrenching upward portamento slide on erhu high register with delicate vibrato",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "rubato"
    ...
    {
      "id": "chinese-traditional-pipa",
      "worldId": "chinese-traditional",
      "name": "Pipa Solo",
      "origin": "Central Asia / China (Tang Dynasty)",
      "era": "Tang Dynasty–Present",
      "description": "Dramatic • Plucked • Virtuosic\nFour-string fretted lute.\nLiu Dehai · Wu Man",
      "characteristicInstruments": [
        "pipa",
        "hand-percussion"
      ],
      ...
      "coreConcepts": [
        "lun-zhi (five-finger circular tremolo roll)",
        "dramatic martial percussive string slapping (sa, fu)",
        "delicate civil poetic melodies",
        "explosive dynamic range"
      ],
      "rhythmicGrammar": [
        "contrasting between silent whispering tremolos and explosive martial battle strums"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "12-tet",
      "signatureCell": "Rapid five-finger lun-zhi tremolo erupting into explosive martial string-slap chords",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "rubato"
    ...
    {
      "id": "chinese-traditional-nanguan",
      "worldId": "chinese-traditional",
      "name": "Nanguan",
      "origin": "Quanzhou, Fujian / Taiwan",
      "era": "Tang/Song Dynasties Roots",
      "description": "Austere • Slow • Classical\nSouthern refined chamber balladry.\nGang-a-tsui Theater · Wang Xinxin",
      "characteristicInstruments": [
        "pipa",
        "xiao",
        "erxian",
      ...
      "keySubstyles": [
        "Quanzhou Nanguan",
        "Southern Court Ballad"
      ],
      "coreConcepts": [
        "austere meditative slowness",
        "horizontal pipa (nanpa) rhythmic foundation",
        "pure vertical flute (dongxiao) resonance",
        "refined court vocal elegance"
      ],
      "rhythmicGrammar": [
        "extremely spacious clapper strikes (paiban) pacing deliberate melodic unfolding"
      ],
      "danceTags": [
        "listening"
      ],
      "tuningSystem": "just-intonation",
      "signatureCell": "Austere paiban clapper stroke followed by long singing dongxiao tone and nanpa pluck",
      "grooveMechanics": {
        "swingPercentage": 50,
        "anticipationOffsetSteps": 0,
        "microtimingFeel": "rubato"
  ...
  "artists": [
    "Shanghai Sizhu Ensemble",
    "Min Huifen",
    "Guan Pinghu",
    "Wu Wenguang",
    "Northern Kunqu Theatre",
    "Hou Shaokui",
    "Mei Lanfang",
    "Cheng Yanqiu",
    "Wang Zhongshan",
